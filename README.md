...
PC 端请使用 Chrome/Edge 打开站点，点击地址栏右侧的“安装”图标并确认。移动端建议用 Chrome 打开站点，进入浏览器菜单，选择“添加到主屏幕”或“安装应用”，再按提示安装。请不要从微信等 App 内置浏览器安装。部分 Android ROM 启动时可能提示打开 Chrome/Edge，通常选“始终允许”即可。
